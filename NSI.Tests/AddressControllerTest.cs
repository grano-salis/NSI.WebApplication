...
namespace NSI.Tests
{
    public class AddressControllerTest
    {
        ...
        IAddressRepository iar => new AddressRepository(db);
        IAddressManipulation iam => new AddressManipulation(iar);
        ...
        {
            var controller = new AddressController(iam);
        ...
        public void CreateAddressFailureTest()
        {
            ...
            var result = controller.PostAddress(model: null);
        ...
        public void CreateNewAddressSuccessTest()
        {
            ...
            mockRepo.Setup(x => x.CreateAddress(address2));
        ...
        public void UpdateAddressSuccessTest()
        {
            ...
            addressRepo.Setup(x => x.CreateAddress(address2));
        ...
        public void DeleteNonExistentAddressFailureTest()
        {
            ...
            // Act
            var result = controller.DeleteAddress(200);
