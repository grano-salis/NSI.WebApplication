...
var UsersService = (function () {
    function UsersService(http) {
        ...
        this._url = environment_1.environment.serverUrl + '/api/users';
        this.headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
    }
    UsersService.prototype.getForMeetings = function (username) {
        var params = new http_1.HttpParams();
        params = params.append('username', username);
        return this.http.get(this._url + '/meetings', { headers: this.headers, params: params });
    };
    UsersService.prototype.getForHearings = function (username) {
        var params = new http_1.HttpParams();
        params = params.append('username', username);
